...
const Footer = ()=>{
    return(
        <footer class="pa4 pa5-l black-70 bt b--black-10" style={{background:"white",display:"flex",justifyContent:"center",flexDirection:"column"}}>
        <div class="mb4-l cf" style={{display:"flex"}}>
